...
router.get('/', async (req, res) => {
  try {
    const [produtos] = await db.execute('SELECT id, descricao, codigo, quantidade, quantidade_minima, posicao, fabricante, referencia, criado_em FROM produto');
...
router.get("/:id", async (req, res) => {
  ...
  try {
    const [produtos] = await db.execute('SELECT id, descricao, codigo, quantidade, quantidade_minima, posicao, fabricante, referencia, criado_em FROM produto WHERE id = ?', [id]);
